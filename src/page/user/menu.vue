<template>
  <el-main>
    <div style="margin-top: 20px">
      ...
      <el-card class="box-card">
        <el-table :data="data.menuList" stripe style="margin-top: 2px; width: 100%" v-loading="loading"
          ...
          <el-table-column prop="method" label="请求方式" width="200">
            <template #default="scope">
              <span style="font-size: 13px" text="bold" v-if="scope.row.method === 'GET'">
              ...
              <span style="font-size: 13px;" v-if="scope.row.method === 'DELETE'">
  ...
  <!-- 添加菜单按钮信息 -->
  <el-dialog v-model="data.createMenuVisible" style="color: #000000; font: 14px" width="460px" center
    ...
    <el-form :label-position="labelPosition" label-width="100px" :model="data.menuForm" style="max-width: 360px">
      ...
      <el-form-item label="上一级:">
        <el-tree-select ref="selectRef" v-model="data.menuForm.parent_id" :data="data.menuList" check-strictly clearable
      ...
      <el-form-item label="排序值:">
        <el-input-number v-model="data.menuForm.sequence" :min="1" :max="10" @change="handleChange" />
      </el-form-item>
      ...
      <el-form-item label="状态:">
        <el-switch v-model="data.menuForm.status" class="ml-2"
