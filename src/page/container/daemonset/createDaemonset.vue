  ...
  <div style="display: flex; flex-direction: column; width: 100%; height: 100%">
    <div style="width: 100%; height: 60px; background: #ffffff; display: flex; align-items: center">
      ...
      <el-breadcrumb separator="/" style="margin-left: 10px; margin-top: 1px">
        ...
        <el-breadcrumb-item
          ><span class="breadcrumb-create-style"> DaemonSets </span>
        </el-breadcrumb-item>
        <el-breadcrumb-item
          ><span class="breadcrumb-create-style"> 创建DaemonSet </span>
        </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
...
const rules = {
  'metadata.name': [{ required: true, message: '请输入 Daemonset 名称', trigger: 'blur' }],
};
...
const confirmCreate = async () => {
  ...
  const [result, err] = await createDaemonset(
    data.cluster,
