    ...
    >
      ...
      <div v-if="data.selectorType === '高级'">
        <el-form-item style="margin-top: -15px">
          <el-button type="text" class="app-action-btn" style="color: #3377ff" @click="addSelector"
            >新增</el-button
          >
        </el-form-item>
        <el-form-item
      ...
      <el-form-item label="Ports" style="margin-top: 20px">
        ...
        >
          ...
          <div style="float: right; cursor: pointer; margin-left: 10px" @click="deletePort(index)">
            <pixiu-icon
              name="icon-shanchu"
              size="14px"
              type="iconfont"
